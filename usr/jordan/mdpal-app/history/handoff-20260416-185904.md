...
- **Receipt v1 format** is required — use `./agency/tools/receipt-sign`, not hand-rolled markdown.
...
- **Flag #136**: my proposal to suppress auto-dispatch when committing only into `agency/receipts/` or with `--staged`.
