...
### Monitor
- `bytyd0zhv` — persistent dispatch monitor (may die across compact; restart with `bash ./agency/tools/dispatch-monitor --include-collab` via Monitor tool if needed)
