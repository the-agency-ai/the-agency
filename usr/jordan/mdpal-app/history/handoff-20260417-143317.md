...
Receipts all under `agency/workstreams/mdpal/qgr/`.
...
- **receipt-sign v1** writes to `agency/workstreams/{W}/qgr/`. `git-safe-commit --no-verify` bypasses the stale retired-path check.
