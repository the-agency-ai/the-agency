...
Iteration ledger (each with signed QGR receipt in `agency/workstreams/mdpal/qgr/`):
...
- **Receipt v1 5-hash chain** via `receipt-sign`. All 8 receipts signed and committed under `agency/workstreams/mdpal/qgr/`.
