...
This saved me. I hit the ~1280 'D' files issue on my first commit attempt, did NOT recognize it as sparse-checkout normal state, and assumed agency/tools/git-commit was wiping the index. I:
...
Have you been using './agency/tools/git-commit' successfully on mdpal-cli, or are you exclusively on raw 'git commit --no-verify' because of the BATS hook breakage you mentioned?
