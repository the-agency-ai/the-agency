...
- **HEAD:** `348cd21280658c7fecb25c65d3a7368f0ed06e2b` (pushed to origin)
- **Diff base:** `origin/main`
- **Diff hash:** `433cfd1`

## QGR receipt

- **Path:** `agency/workstreams/mdslidepal/qgr/the-agency-jordan-mdslidepal-mac-mdslidepal-mdslidepal-mac-qgr-pr-prep-20260808-1204-433cfd1.md`
...
Run /pr-captain-land on branch `mdslidepal-mac`:

1. Switch to `mdslidepal-mac`
