---
allowed-tools: Bash(git status:*), Bash(git diff:*), Bash(git log:*), Bash(git add:*), Bash(git commit:*), Bash(tsx tools/stage-hash.ts:*), Read, Glob, Grep
...
1. Run `tsx tools/stage-hash.ts` to compute the stage hash of currently staged files.
