...
1. Locate the A&D document (search `usr/*/` and `docs/plans/`)
...
1. Locate the PVR document (search `usr/*/`)
...
Update the scoped handoff file (`usr/jordan/{project}/handoff.md`) with:
