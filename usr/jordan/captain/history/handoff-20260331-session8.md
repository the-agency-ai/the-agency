...
2. **9dee22b** — Move ~95 tools `tools/` → `agency/tools/`, rename (git-safe-commit, git-tag, git-sync, agency-whoami, tool-create), new tools (git-fetch, telemetry), standardize JSONL logging, fix code-review false positive
...
Filed `agency/workstreams/agency/seeds/browser-access-bug-20260331.md`. Four paths all broken:
