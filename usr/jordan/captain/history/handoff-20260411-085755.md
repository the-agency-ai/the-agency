...
2. **Flag #84** — PR tool needed (like git-safe-commit wraps commit). Enforcement Triangle: tool + skill + hookify block on raw gh pr create.
...
**Outline:** `agency/workstreams/agency/seeds/workshop-outline-republic-poly-20260410.md`
