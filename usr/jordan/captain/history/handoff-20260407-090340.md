...
### What shipped Day 31:
- `agency/tools/collaboration` (v2.0.0) — cross-repo dispatch lifecycle tool (check, list, read, resolve, reply, push)
...
Collaboration repos configured in `agency.yaml`. Tool: `./agency/tools/collaboration`. Monofolk has 3 pending dispatches from us (2 replies + release notes).
...
5. Read role: `agency/agents/captain/agent.md`
