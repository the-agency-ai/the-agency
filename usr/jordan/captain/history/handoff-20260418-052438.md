...
- Prompt:
  ...
  Pre-flight reminder: you are on `main`, tree should be clean. Read handoff first: `./agency/tools/handoff read`.
  ```
...
- Command: `/opt/homebrew/bin/python3.13 ./agency/tools/dispatch-monitor --include-collab`
- persistent: `true`
- timeout_ms: `3600000`
