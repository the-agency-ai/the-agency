...
| 9 | Transcript mining tool | Formalize to agency/tools/. Downstream: agentic pipeline for friction detection. |
...
| 27 | Seeds location | agency/workstreams/{name}/seeds/. Belongs to workstream, not agent. |
...
| `agency/hookify/hookify.block-testuser-paths.md` | NEW — env leak block |
