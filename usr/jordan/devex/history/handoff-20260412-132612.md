...
### New tools and libs
- `agency/tools/lib/_docker-heal` — auto-detect Docker Desktop socket on macOS (fixes GH #58). 12 BATS tests.
- `agency/tools/lib/_test-isolation` — extracted from test_helper.bash so adopters get it via agency update. Pure refactor.
