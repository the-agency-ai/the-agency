...
- Template for adopters (claude/templates/tests/test_helper.bash)
- _agency-init updated to copy lib + template
- enforcement.yaml bumped to level 3

## Scaffold PVR written
claude/workstreams/devex/scaffold-pvr-20260414.md — NestJS + Next.js SPEC:PROVIDER. 3 open questions for principal (monorepo structure, pnpm, vitest).
