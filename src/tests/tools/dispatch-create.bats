...
@test "dispatch create: --help shows usage" {
    run "$MOCK_REPO/agency/tools/dispatch" create --help
    assert_success
...
@test "dispatch create: fails without --to" {
    run "$MOCK_REPO/agency/tools/dispatch" create --subject "test" --body "content"
    assert_failure
    assert_output_contains "--to"
}

@test "dispatch create: fails without --subject" {
    run "$MOCK_REPO/agency/tools/dispatch" create --to "jordan/captain" --body "content"
    assert_failure
    assert_output_contains "--subject"
}
...
@test "dispatch create: creates file and DB record" {
    run "$MOCK_REPO/agency/tools/dispatch" create --to "test-repo/testprincipal/captain" --subject "Test dispatch" --body "Test content"
    assert_success
...
@test "dispatch create: DB record has correct fields" {
    "$MOCK_REPO/agency/tools/dispatch" create --to "test-repo/testprincipal/captain" --subject "Field check" --body "Directive content" --type directive --priority high
...
@test "dispatch create: payload file exists with correct frontmatter" {
    "$MOCK_REPO/agency/tools/dispatch" create --to "test-repo/testprincipal/captain" --subject "Frontmatter test" --body "Frontmatter test content"
...
@test "dispatch create: default type is dispatch" {
    "$MOCK_REPO/agency/tools/dispatch" create --to "test-repo/testprincipal/captain" --subject "Default type" --body "Default type content"
...
@test "dispatch create: slug in filename comes from subject" {
    "$MOCK_REPO/agency/tools/dispatch" create --to "test-repo/testprincipal/captain" --subject "Code Review Findings" --body "Review content"
...
@test "dispatch create: type prefix in filename" {
    "$MOCK_REPO/agency/tools/dispatch" create --to "test-repo/testprincipal/captain" --subject "Fix this" --body "Fix content" --type review
...
@test "dispatch create: validates type against enum" {
    run "$MOCK_REPO/agency/tools/dispatch" create --to "test-repo/testprincipal/captain" --subject "Bad" --body "content" --type invalid
    assert_failure
...
@test "dispatch create: accepts all valid types" {
    for dtype in directive seed review review-response commit master-updated escalation dispatch; do
        run "$MOCK_REPO/agency/tools/dispatch" create --to "test-repo/testprincipal/captain" --subject "Type $dtype" --body "Content for $dtype" --type "$dtype"
        assert_success
    done
...
@test "dispatch create: rejects invalid priority" {
    run "$MOCK_REPO/agency/tools/dispatch" create --to "test-repo/testprincipal/captain" --subject "Bad" --body "content" --priority critical
    assert_failure
...
@test "dispatch create: --reply-to with integer sets in_reply_to FK" {
    ...
    "$MOCK_REPO/agency/tools/dispatch" create --to "test-repo/testprincipal/captain" --subject "Original" --body "Original content"

    # Create reply
    "$MOCK_REPO/agency/tools/dispatch" create --to "test-repo/testprincipal/captain" --subject "Reply" --body "Reply content" --reply-to 1 --type review-response
...
@test "dispatch-create wrapper: works as before" {
    run "$MOCK_REPO/agency/tools/dispatch-create" --to "test-repo/testprincipal/captain" --subject "Wrapper test" --body "Wrapper content"
    assert_success
    assert_output_contains "ID:"
    assert_output_contains "File:"
...
@test "dispatch: --help shows all subcommands" {
    run "$MOCK_REPO/agency/tools/dispatch" --help
    assert_success
...
@test "dispatch: --version shows version" {
    run "$MOCK_REPO/agency/tools/dispatch" --version
    assert_success
