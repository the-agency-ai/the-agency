...
DOCS_DIR="${REPO_ROOT}/agency/REFERENCE"
...
@test "docs: QUALITY-GATE.md exists" {
    assert_file_exists "${DOCS_DIR}/REFERENCE-QUALITY-GATE.md"
}

@test "docs: DEVELOPMENT-METHODOLOGY.md exists" {
    assert_file_exists "${DOCS_DIR}/REFERENCE-DEVELOPMENT-METHODOLOGY.md"
}

@test "docs: CODE-REVIEW-LIFECYCLE.md exists" {
    assert_file_exists "${DOCS_DIR}/REFERENCE-CODE-REVIEW-LIFECYCLE.md"
}

@test "docs: FEEDBACK-FORMAT.md exists" {
    assert_file_exists "${DOCS_DIR}/REFERENCE-FEEDBACK-FORMAT.md"
}

@test "docs: PR-LIFECYCLE.md exists" {
    assert_file_exists "${DOCS_DIR}/REFERENCE-PR-LIFECYCLE.md"
}

@test "docs: TELEMETRY.md exists" {
    assert_file_exists "${DOCS_DIR}/REFERENCE-TELEMETRY.md"
}
...
@test "docs: QUICK-START.md exists" {
    assert_file_exists "${DOCS_DIR}/REFERENCE-QUICK-START.md"
}

@test "docs: PRINCIPALS.md exists" {
    assert_file_exists "${DOCS_DIR}/REFERENCE-PRINCIPALS.md"
}

@test "docs: SECRETS.md exists" {
    assert_file_exists "${DOCS_DIR}/REFERENCE-SECRETS.md"
}

@test "docs: TESTING.md exists" {
    assert_file_exists "${DOCS_DIR}/REFERENCE-TESTING.md"
}
...
@test "docs: QUALITY-GATE.md is not empty" {
    [[ -s "${DOCS_DIR}/REFERENCE-QUALITY-GATE.md" ]]
}

@test "docs: DEVELOPMENT-METHODOLOGY.md is not empty" {
    [[ -s "${DOCS_DIR}/REFERENCE-DEVELOPMENT-METHODOLOGY.md" ]]
}

@test "docs: CODE-REVIEW-LIFECYCLE.md is not empty" {
    [[ -s "${DOCS_DIR}/REFERENCE-CODE-REVIEW-LIFECYCLE.md" ]]
}

@test "docs: FEEDBACK-FORMAT.md is not empty" {
    [[ -s "${DOCS_DIR}/REFERENCE-FEEDBACK-FORMAT.md" ]]
}

@test "docs: PR-LIFECYCLE.md is not empty" {
    [[ -s "${DOCS_DIR}/REFERENCE-PR-LIFECYCLE.md" ]]
}

@test "docs: TELEMETRY.md is not empty" {
    [[ -s "${DOCS_DIR}/REFERENCE-TELEMETRY.md" ]]
}
