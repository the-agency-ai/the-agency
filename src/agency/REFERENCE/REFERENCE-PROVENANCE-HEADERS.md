...
Both bash and Python 3.13+ are valid languages for tools in `agency/tools/`.
...
|-------|----------|-----------|
| **Framework tool** (plan work, shipped to all projects) | `agency/tools/` | Committed, reviewed, permanent |
...
5. If it proves broadly useful, propose moving it to `agency/tools/`.
