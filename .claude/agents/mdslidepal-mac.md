...
1. `usr/jordan/mdslidepal/mdslidepal-mac-handoff.md` — your current state and next action
...
- `usr/jordan/mdslidepal/mdslidepal-web-handoff.md` — your counterpart's handoff (shared context)
