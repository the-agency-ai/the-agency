...
1. `usr/jordan/mdslidepal-web/mdslidepal-web-handoff.md` — your current state and next action
...
- `agency/workstreams/mdslidepal/plan-mdslidepal-web-20260411.md` — your plan (PVR + A&D + Plan)
...
- `agency/workstreams/mdslidepal/fixtures/` — 8 acceptance test fixtures (your MVP must pass 01-05 + 08)
- `agency/workstreams/mdslidepal/plan-b/` — the Plan B safety net (your Iteration 1 builds ON TOP of this)
- Counterpart handoff: `usr/jordan/mdslidepal-mac/mdslidepal-mac-handoff.md`
