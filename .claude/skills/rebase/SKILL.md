...
Rebase rewrites history, breaks worktree merge-bases, and caused a fleet-wide data loss incident in a multi-worktree monorepo. See `agency/REFERENCE-GIT-MERGE-NOT-REBASE.md` for the full rationale and incident report.
