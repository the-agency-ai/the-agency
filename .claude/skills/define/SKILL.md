...
Glob `claude/workstreams/*/**/*-pvr-*.md` and `usr/*/**/*-pvr-*.md` for existing PVR files. If found, offer to continue from the most recent one.
...
PVR location: `claude/workstreams/{workstream}/{project}-pvr-{YYYYMMDD}.md` or `usr/{principal}/{project}/{project}-pvr-{YYYYMMDD}.md`.
