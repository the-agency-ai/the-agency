...
|-------------|----------------|--------------------------|
| Agent | `{repo}/{principal}/{agent}` | `agency/data/dispatches/` |
...
Commit message agent prefixes (`housekeeping/captain: ...`) stay bare-form. They are repo-local context and do not need qualification. See `agency/REFERENCE-GIT-MERGE-NOT-REBASE.md` § "Git & Remote Discipline" for the full commit message format.
