...
| **QG Protocol — 10 Steps** | 7-31 | PM agent §1, agency/REFERENCE-QUALITY-GATE.md | Covered |
| **QG — Commit Discipline** | 33-39 | PM agent §3, CLAUDE-USER-DRAFT.md §QG (pointer) | Covered |
| **QGR Format — Full template** | 41-135 | PM agent §2, agency/REFERENCE-QUALITY-GATE.md | Covered |
...
| **Dev Methodology — Quality Gates** | 285-291 | CLAUDE-USER-DRAFT.md §QG (iteration/phase distinction), agency/REFERENCE-DEVELOPMENT-METHODOLOGY.md | Covered |
| **Phase Completion procedure** | 292-316 | /phase-complete skill, agency/REFERENCE-DEVELOPMENT-METHODOLOGY.md, PM agent §3 (landing steps added) | Covered |
| **Pre-Phase Review procedure** | 318-327 | /pre-phase-review skill, PM agent §5, agency/REFERENCE-DEVELOPMENT-METHODOLOGY.md | Covered |
...
| **Session Handoff — trigger table** | 384-398 | Triggers encoded in boundary skills + hooks. Captain agent has trigger list. Full table in agency/REFERENCE-DEVELOPMENT-METHODOLOGY.md | Covered |
...
| **Feedback — Header/Identity** | 422-435 | agency/REFERENCE-FEEDBACK-FORMAT.md, CLAUDE-USER-DRAFT.md §Feedback (pointer) | Covered |
| **Feedback — Structure** | 437-446 | agency/REFERENCE-FEEDBACK-FORMAT.md | Covered |
| **Feedback — Principles** | 448-453 | agency/REFERENCE-FEEDBACK-FORMAT.md | Covered |
...
| **Three Review Tools table** | 539-549 | Captain agent §Three Review Tools, agency/REFERENCE-CODE-REVIEW-LIFECYCLE.md | Covered |
...
| **Worktree Dispatch Handling** | 586-618 | Captain agent (pointer to ref), agency/REFERENCE-CODE-REVIEW-LIFECYCLE.md | Covered |
| **Review File Convention** | 620-629 | agency/REFERENCE-CODE-REVIEW-LIFECYCLE.md | Covered |
