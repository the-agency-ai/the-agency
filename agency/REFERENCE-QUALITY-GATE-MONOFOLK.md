...
- **Hookify enforcement rules:**
  ...
  - `hookify.require-plan-update.md` — warns on `git commit` if plan file not in staged changes
  - `hookify.no-push-master.md` — blocks push to master
  - `hookify.warn-on-push.md` — warns on any `git push`
