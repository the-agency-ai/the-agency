...
- **Contribution model rollout** — the three-ring contribution model reference (`claude/REFERENCE-CONTRIBUTION-MODEL.md`) would be ref-injector-provided, not CLAUDE.md inline
