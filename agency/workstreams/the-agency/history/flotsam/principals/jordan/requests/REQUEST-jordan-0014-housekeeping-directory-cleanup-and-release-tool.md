...
### 2. Create `agency/config/` directory
```bash
mkdir -p agency/config/
mv claude/config.yaml agency/config/agency.yaml
```

Update tools that reference `claude/config.yaml` to use `agency/config/agency.yaml`.
...
- [ ] Create `agency/config/` directory
- [ ] Move and rename `config.yaml` to `agency/config/agency.yaml`
...
- [ ] `agency/config/agency.yaml` exists (old config.yaml removed)
...
|----------|----------|--------|
| `claude/config.yaml` | `agency/config/agency.yaml` | Move + rename |
...
- Verified agency/config/ with agency.yaml, agency-dependencies.yaml
