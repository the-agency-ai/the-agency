...
- `agency/templates/principal/` with template structure
...
**Proposed Fix:**
1. Create `agency/templates/principal/` with:
...
**What Gets Updated:**
- `tools/` - all CLI tools
- `agency/templates/` - templates for agents, principals, etc.
...
- [ ] `agency/templates/principal/` exists with template
